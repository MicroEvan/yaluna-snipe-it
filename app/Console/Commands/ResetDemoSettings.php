...
class ResetDemoSettings extends Command
{
     ...
     * @var string
     */
    protected $description = 'This will reset the yaluna-snipe-it demo settings back to default. ';
    ...
    public function handle()
    {
        ...
        $settings->site_name = 'yaluna-snipe-it Asset Management Demo';
        $settings->auto_increment_assets = 1;
        $settings->logo = 'snipe-logo.png';
        $settings->alert_email = 'service@yaluna-snipe-it.io';
