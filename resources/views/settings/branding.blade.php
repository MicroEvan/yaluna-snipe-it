                            ...
                            <div class="form-group {{ $errors->has('site_name') ? 'error' : '' }}">
                                ...
                                <div class="col-md-7 required">
                                    @if (config('app.lock_passwords')===true)
                                        <input class="form-control" disabled="disabled" placeholder="Yaluna Asset Management" name="site_name" type="text" value="{{ old('site_name', $setting->site_name) }}" id="site_name">
                                        <p class="text-warning">
                                            <x-icon type="locked" />
                                            {{ trans('general.feature_disabled') }}</p>
                                    @else
                                        <input class="form-control" placeholder="Yaluna Asset Management" required="required" name="site_name" type="text" value="{{ old('site_name', $setting->site_name) }}" id="site_name">
                                    @endif
