...
return [
    ...
    'importing_help'        => 'Ви можете імпортувати активи, аксесуари, ліцензії, компоненти, витратні матеріали та користувачів за допомогою файлу CSV. <br><br>CSV має бути розділений комами та відформатований із заголовками, які відповідають заголовкам у <a href="https://yaluna-asset-management.yalunaictsolutions.com/docs/getting-started#/" target="_new"> зразка CSV у документації</a>.',
